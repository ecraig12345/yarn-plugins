...
```
yarn plugin import https://raw.githubusercontent.com/ecraig12345/yarn-plugins/engines_v0.1.2/plugins/engines/dist/plugin.js
```

If you'd like a non-minified version for debugging:

```
yarn plugin import https://raw.githubusercontent.com/ecraig12345/yarn-plugins/engines_v0.1.2/plugins/engines/dist/plugin.dev.js
```
